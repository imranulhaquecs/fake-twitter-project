...
export class Utilities {
  ...
  public static findHttpResponseMessage(messageToFind: string, data: HttpResponse<any> | any, seachInCaptionOnly = true, includeCaptionInResult = false): any {
  ...
  public static splitInTwo(text: string, separator: string): { firstPart: string, secondPart: any } {
  ...
  public static toLowerCase(items: string[]): any;
  public static toLowerCase(items: any): any | string[] {
