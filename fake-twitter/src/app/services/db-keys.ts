...
export class DBkeys {
    ...
    public static readonly REFERENCE_DATA = "reference_data";
    public static readonly STANDING_DATA = "standing_data";

    public static readonly STANDING_DATA_CACHE = "standing_data_cache";
}
