...
export class OidcHelperService {
    ...
    private readonly _verifyAccountUrl: string = "/api/account/VerifyAccount";
    private get VerifyAccountUrl() { return this.configurations.baseUrl + this._verifyAccountUrl; }
    ...
    getVerifyAccountEndpoint<T>(userEmail: string, token: string): Observable<T> {
      ...
      return this.http.get<T>(endpointUrl, { headers: header });
    }
